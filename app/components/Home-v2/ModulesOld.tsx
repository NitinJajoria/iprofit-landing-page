...
const features: FeatureBlock[] = [
	...
	},
	{
		...
		desc: "Keep track of your stock levels, receive alerts for low stock, and automate purchase orders.",
		bullets: [
			...
			<div className="container relative z-10 mx-auto px-6 lg:px-20">
				...
				<div className="flex flex-col gap-10 lg:gap-20">
					{features.map((feat) => (
						<div
							key={feat.title}
							className={`flex flex-col gap-12 lg:grid lg:grid-cols-2 lg:items-center lg:gap-16 ${
								feat.reversed ? "lg:direction-rtl" : ""
							}`}
						>
							{/* Content Column */}
							<div
								className={`flex flex-col ${feat.reversed ? "lg:direction-ltr lg:order-2" : ""}`}
							>
								<FadeInUp delay={0.1}>
									<span
