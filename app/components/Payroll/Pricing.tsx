...
export default function Pricing() {
	return (
		<section className="bg-white px-4 pt-0 pb-0 sm:px-6 lg:px-8">
			<div className="mx-auto max-w-[1233px]">
				{/* Header */}
				<div className="mb-10 text-center lg:mb-16">
					<h2
						className="mb-4 font-medium text-[32px] leading-[1.2] text-[#151515] sm:text-[48px] lg:text-[64px] lg:leading-[117%]"
						style={{ fontFamily: "'Helvetica Now Display', sans-serif" }}
					>
						Plans that fit every stage
					</h2>
					<p
						className="font-medium text-[20px] leading-tight text-[#151515] sm:text-[28px] lg:text-[38px] lg:leading-[37.18px] lg:tracking-[-1%]"
						style={{ fontFamily: "'Helvetica Now Display', sans-serif" }}
					>
				...
				<div className="grid grid-cols-1 gap-6 md:grid-cols-3 lg:gap-8">
					{plans.map((plan, index) => (
						<div
							key={index}
							className={`relative flex flex-col overflow-hidden rounded-[24px] p-6 transition-all hover:shadow-xl lg:rounded-[32px] lg:p-8 ${
								plan.isDark
									? "bg-black text-white"
