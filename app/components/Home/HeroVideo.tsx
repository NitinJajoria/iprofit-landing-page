		...
		>
			...
			<div className="absolute top-0 left-0 w-full h-full pointer-events-none opacity-40">
				<div
					...
					style={{
						background:
							"radial-gradient(circle, rgba(0, 138, 221, 0.08) 0%, rgba(248, 251, 255, 0) 70%)",
					}}
				/>
			</div>
				...
				<div className="flex flex-col items-center gap-10 lg:flex-row lg:items-center">
					...
					<div className="relative w-full lg:w-1/2">
						...
						>
							...
							>
								<p className="font-outfit text-xs font-semibold uppercase tracking-wider text-[#6B7280]">
									Payroll Users
								</p>
								<p className="mt-2 font-outfit text-3xl font-bold text-[#0D1117]">
									11,000+
								</p>
							...
							>
								<p className="font-outfit text-xs font-bold uppercase tracking-wider text-[#0D1117]">
									Salaries Processed
								</p>
								<p className="mt-1 font-outfit text-2xl font-black text-[#008ADD]">
									16Cr+{" "}
