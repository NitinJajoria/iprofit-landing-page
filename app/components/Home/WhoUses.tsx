...
export default function WhoUses({}: {
	...
	return (
		<section className="relative bg-[#FAFBFF] py-10 lg:py-16">
					...
					<div className="space-y-4 lg:w-[60%]">
						{audiences.map((item, i) => (
							<FadeInUp key={i} delay={i * 0.1}>
								<div className="group flex items-start gap-4 h-full rounded-[2rem] border border-slate-100 bg-white p-8 shadow-sm transition-all duration-500 hover:shadow-2xl hover:shadow-blue-500/5 hover:-translate-y-1">
