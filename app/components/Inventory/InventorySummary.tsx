...
const benefits = [
	...
	"Reduced stock losses and pilferage",
				...
				<div className="flex flex-col items-center text-center">
					<div className="max-w-4xl">
						<h2
							...
							style={{ fontFamily: "'Outfit', sans-serif" }}
						>
							See How iProfit Transforms Inventory Management
						</h2>
						<p
							className="mb-10 text-[18px] font-normal leading-relaxed text-[#31373D] sm:text-[20px] lg:text-[24px]"
							style={{ fontFamily: "'Outfit', sans-serif" }}
						>
							From purchase orders and stock receipts to audits and reporting —
							iProfit helps businesses reduce waste, improve control, and scale
							inventory operations confidently.
						</p>
						<BookDemoButton
							href="https://calendly.com/iprofitsales/30min"
							className="h-[64px] px-12 text-[18px] font-bold"
						>
							👉 Book a Call with an Inventory Expert
						</BookDemoButton>
					</div>
				</div>
			</div>
