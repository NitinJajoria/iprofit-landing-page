				...
				<div className="flex flex-col gap-16 lg:flex-row lg:items-center lg:justify-between">
					...
					<div className="max-w-2xl lg:flex-1">
						...
						<h1 className="mb-8 font-outfit text-[32px] font-semibold leading-tight text-[#080808] sm:text-[40px] lg:text-[48px] lg:leading-[80px]">
							...
							<span className="font-medium">Supply Chain and Stock.</span>
						</h1>
						...
						<p className="max-w-xl font-outfit text-[16px] font-normal leading-[1.6] text-[#31373D] sm:text-[18px] lg:text-[19px] lg:leading-[40.8px]">
							From procurement to stock audits, iProfit’s Inventory Management
							software gives you end-to-end visibility of goods, vendors, and
							warehouses—minimising losses and ensuring smooth operations.
							<br />
							<br />
							Whether you manage one warehouse or multiple locations, iProfit
							helps you track, plan, and optimise inventory in real time.
						</p>
					</div>
						...
						<div className="p-0 sm:p-4">
							...
							<form className="space-y-5">
								...
								<p className="font-outfit text-[12px] font-normal leading-none text-[#6B7280]">
									By providing your information, you hereby consent to the
									iProfit Cookie Policy and Privacy Policy.
								</p>
