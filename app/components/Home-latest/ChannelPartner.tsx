...
const partnerFeatures = [
	{
		...
		description:
			"Comprehensive training programs and certification to get your team up to speed with iProfit ecosystem.",
		icon: (
			<svg
				width="24"
				height="24"
	...
	},
	{
		...
		description:
			"Joint marketing, events, and materials to grow your presence and credibility in the enterprise market.",
		icon: (
			<svg
				width="24"
				height="24"
	...
	},
	{
		...
		description:
			"Attractive commission structures and recurring revenue streams for every successful referral.",
		icon: (
			<svg
				width="24"
				height="24"
...
export default function ChannelPartner() {
	return (
		<>
			...
			<section className="relative overflow-hidden bg-gradient-to-br from-[#008ADD] to-[#0066B8] py-6 lg:py-10">
				{/* Background Decor */}
