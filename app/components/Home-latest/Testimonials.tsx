				...
				<div className="max-w-7xl mx-auto">
					...
					<div className="mx-auto mb-16 max-w-4xl text-center">
						...
						<motion.h2
							...
							className="mb-5 font-outfit font-extrabold leading-[1.15] tracking-tight text-[#0D1117] text-[32px] sm:text-[40px] lg:text-[50px]"
						>
							...
							>
								<div className="flex flex-col items-center text-center md:flex-row md:items-start md:text-left">
									...
									<div>
										...
										{/* Quote */}
										<p className="mb-6 font-outfit text-xl font-semibold leading-relaxed text-[#0D1117] md:text-2xl line-clamp-3">
											&ldquo;{currentTestimonial.quote}&rdquo;
										</p>

										{/* Author Info */}
										<p className="font-outfit text-lg font-bold text-[#0D1117]">
