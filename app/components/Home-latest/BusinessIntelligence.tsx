...
export default function BusinessIntelligence() {
	return (
		<section className="relative py-10 md:py-16 bg-[#F1F5F9]/10 overflow-hidden">
				...
				<div className="flex flex-col items-center text-center">
					<FadeInUp>
						<div className="mb-4 inline-flex items-center gap-2 rounded-full border border-[#008ADD]/10 bg-[#008ADD]/5 px-4 py-1.5">
							...
							<p className="font-outfit text-xs font-bold tracking-widest text-[#008ADD] uppercase">
						...
						<h2 className="font-outfit text-3xl font-bold text-[#0D1117] md:text-5xl tracking-tight leading-tight">
							Total Visibility.{" "}
							<span className="text-[#008ADD]">Smarter Decisions.</span>
						</h2>

						<p className="mt-6 font-outfit text-lg leading-relaxed text-slate-500 max-w-2xl mx-auto">
									...
									<StaggerItem key={item.label}>
										<div className="group relative flex items-center gap-4 rounded-2xl bg-white p-5 shadow-sm border border-slate-100 transition-all duration-300 hover:shadow-xl hover:border-blue-200 hover:-translate-y-1">
											...
											<div className="text-left">
												<span className="block text-xl font-outfit font-semibold text-[#1E293B] group-hover:text-[#008ADD] transition-colors">
													{item.label}
												</span>
												<span className="text-sm font-outfit text-slate-400 font-medium">
													Auto-synced data
												</span>
											</div>
