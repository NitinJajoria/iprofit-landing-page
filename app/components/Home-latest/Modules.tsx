...
const modules = [
	...
	},
	{
		...
		image: "/advantage/inventory-management.png",
	...
	// 	],
	// 	image: "/advantage/finance.png", // Placeholder, need to confirm image
			...
			<div className="container mx-auto px-6 relative z-10">
				...
				<div className="mx-auto mb-20 max-w-6xl text-center lg:text-left flex flex-col lg:flex-row lg:items-end lg:justify-between gap-8">
					<div className="lg:max-w-[60%]">
						...
						>
							<div className="mb-4 inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#008ADD]/5 border border-[#008ADD]/10">
								<span className="text-[10px] font-black uppercase tracking-[0.2em] text-[#008ADD]">The Ecosystem</span>
							</div>
					...
					<div className="lg:max-w-[35%] lg:pb-3">
						...
						>
							Every module is natively integrated. No APIs, no bridges,
							just a single source of truth for your entire operation.
						</motion.p>
					</div>
				</div>
										...
										<div className="p-8 sm:p-10">
											...
											<ul className="space-y-3">
												{mod.bulletPoints.map((point, idx) => (
													<li key={idx} className="flex items-center text-slate-500 font-medium font-outfit text-sm sm:text-base">
										...
										<div className="mt-auto px-6 pb-0 group-hover:px-4 transition-all duration-500">
											<div className="relative aspect-[16/9] w-full overflow-hidden rounded-t-2xl border-t border-x border-slate-100 bg-slate-50 shadow-inner">
												...
												<div className="absolute bottom-4 right-4 h-12 w-12 rounded-full bg-white/80 backdrop-blur-md flex items-center justify-center shadow-lg border border-white/50 opacity-0 group-hover:opacity-100 transition-all duration-500 translate-y-4 group-hover:translate-y-0">
													<svg className="h-5 w-5 text-[#008ADD]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
							...
							>
								...
								>
									<div className="mb-6 flex h-14 w-14 items-center justify-center rounded-2xl bg-white shadow-sm border border-slate-100 group-hover:bg-[#008ADD] group-hover:text-white transition-all duration-500 group-hover:scale-110">
										{/* Dynamic Icon choice or abstract element */}
										<svg className="h-7 w-7 transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor">
									...
									<ul className="mb-6 space-y-3 flex-1">
										{mod.bulletPoints.map((point, idx) => (
											<li key={idx} className="flex items-center text-slate-500 font-medium font-outfit text-xs sm:text-sm">
									...
									<div className="mt-auto flex items-center text-xs font-bold text-[#008ADD] opacity-0 group-hover:opacity-100 transition-all duration-500 translate-x-[-10px] group-hover:translate-x-0">
										LEARN MORE <svg className="ml-1 h-3 w-3" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="3"><path d="M13 7l5 5m0 0l-5 5m5-5H6" /></svg>
									</div>
								</Link>
							</motion.div>
						))}
