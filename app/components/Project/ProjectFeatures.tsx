...
const features = [
  {
    id: 1,
    title: "Project Setup & Work Breakdown",
    description: "Create projects, define scopes, tasks, and deliverables with structured work breakdowns.",
  ...
  },
  {
    ...
    description: "Assign manpower, assets, and materials while tracking utilisation in real time.",
    image: "/Payroll/PM2.png",
    bgColor: "bg-[#F3E8FF]",
  },
  {
    id: 3,
    title: "Milestone & Progress Monitoring",
    description: "Monitor project milestones, timelines, and completion status with live updates.",
  ...
  },
  {
    ...
    description: "Compare planned budgets against real-time costs to avoid overruns.",
    image: "/Payroll/PM2.png",
    bgColor: "bg-[#E0F2FE]",
  },
  {
    ...
    description: "Centralised storage for project documents, approvals, and communication.",
  ...
  },
  {
    ...
    description: "Real-time dashboards for project health, risks, and performance metrics.",
    image: "/Payroll/PM3.png",
    bgColor: "bg-[#FEE2E2]",
  },
];
