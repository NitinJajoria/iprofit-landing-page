...
export default function EGovernanceHero() {
	return (
			...
			<div className="relative z-10 mx-auto max-w-[1400px] pt-24 text-center lg:pt-32">
				...
				>
					<span className="lg:leading-[var(--desktop-lh)]">
						Digitising Governance. Strengthening Accountability. Improving
						Citizen Services.
					</span>
				</h1>
				...
				>
					<span className="lg:leading-[var(--desktop-lh)]">
						Built for government departments and public institutions that need
						transparency, compliance, and control—at scale.
					</span>
				</p>
