			...
			<div className="relative z-10 mx-auto max-w-[1400px] pt-24 text-center lg:pt-32">
				...
				>
					<span className="lg:leading-[var(--desktop-lh)]">
						One Platform to Run, Control & Scale Your Business
					</span>
				</h1>
				...
				>
					<span className="lg:leading-[var(--desktop-lh)]">
						Built for MSMEs and startups that need visibility, compliance, and
						efficiency—without complex systems or high costs.
					</span>
				</p>
