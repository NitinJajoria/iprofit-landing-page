...
const whyItems = [
	{
		id: 1,
		title: "Affordable and cost-effective plans",
		image: "/IT/IT1.png",
		isBlue: false,
	},
	{
		id: 2,
		title: "Easy to use with minimal training required",
		image: "/IT/IT2.png",
		isBlue: true,
	},
	{
		id: 3,
		title: "Built for Indian GST and statutory compliance",
		image: "/IT/IT2.png",
		isBlue: true,
	},
	{
		id: 4,
		title: "Modular and scalable as your business grows",
		image: "/IT/IT1.png",
		isBlue: false,
	},
	{
		id: 5,
		title: "Eliminates dependence on multiple tools",
		image: "/IT/IT1.png",
		isBlue: false,
	},
];

export default function MSMEWhy() {
	return (
		<section className="bg-white px-4 sm:px-6 lg:px-8">
			<div className="mx-auto max-w-[1400px] px-4 sm:px-6 md:px-10 lg:px-20">
				...
				>
					Why MSMEs & Startups Choose iProfit
				</h2>
				...
				<div className="mt-16 lg:mt-24">
					...
					>
						Whether you&apos;re a startup just getting started or an MSME
						scaling operations, iProfit grows with you.
					</p>
				</div>
			</div>
		</section>
