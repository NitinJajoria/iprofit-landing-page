...
const whyItems = [
	{
		id: 1,
		title: "Compatible: Seamlessly integrates with existing e-Gov systems",
		image: "/IT/IT1.png",
		isBlue: false,
	},
	{
		id: 2,
		title:
			"Priority Support: Dedicated helpdesk for mission-critical operations",
		image: "/IT/IT2.png",
		isBlue: true,
	},
	{
		id: 3,
		title:
			"Government-Authorised: Built to align with Digital India initiatives",
		image: "/IT/IT2.png",
		isBlue: true,
	},
	{
		id: 4,
		title: "Advanced Reporting: Real-time MIS and drill-down dashboards",
		image: "/IT/IT1.png",
		isBlue: false,
	},
	{
		id: 5,
		title: "Secure & Scalable: Designed for large-scale public deployments",
		image: "/IT/IT1.png",
		isBlue: false,
	},
];

export default function EGovernanceWhy() {
	return (
		<section className="bg-white px-4 sm:px-6 lg:px-8">
			<div className="mx-auto max-w-[1400px] px-4 sm:px-6 md:px-10 lg:px-20">
				...
				>
					Why Government Departments Choose InGov ERP
				</h2>
				...
				<div className="mt-16 lg:mt-24">
					...
					>
						InGov ERP is the trusted partner for digital transformation in the
						public sector.
					</p>
				</div>
			</div>
