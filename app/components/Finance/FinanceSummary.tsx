...
const benefits = [
	...
	"Improved financial control & transparency",
];
				...
				<div className="flex flex-col items-center text-center">
					<div className="max-w-4xl">
						<h2
							...
							style={{ fontFamily: "'Outfit', sans-serif" }}
						>
							See How iProfit Transforms Finance Operations
						</h2>
						<p
							className="mb-10 text-[18px] font-normal leading-relaxed text-[#31373D] sm:text-[20px] lg:text-[24px]"
							style={{ fontFamily: "'Outfit', sans-serif" }}
						>
							From managing accounting and taxation to integrating payroll,
							projects, and assets — iProfit helps businesses save time, reduce
						...
						>
							👉 Book a Call with a Finance Expert
						</BookDemoButton>
					</div>
				</div>
			</div>
