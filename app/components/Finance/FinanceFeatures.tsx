...
const features = [
  {
    id: 1,
    title: "Branch-Based Accounting",
    description: "Maintain separate books for multiple branches while keeping consolidated visibility.",
  ...
  },
  {
    ...
    description: "Plan, allocate, and track budgets with real-time variance analysis.",
    image: "/Payroll/PM2.png",
    bgColor: "bg-[#F3E8FF]",
  },
  {
    id: 3,
    title: "Tax Compliance & GST Filing",
    description: "Automated GST calculations, returns, and compliance-ready reports.",
  ...
  },
  {
    ...
    description: "Real-time bank feeds, reconciliations, and payment tracking.",
    image: "/Payroll/PM2.png",
    bgColor: "bg-[#E0F2FE]",
  },
  {
    ...
    description: "Track revenue, costs, and profitability at a project level.",
    image: "/Payroll/PM1.png",
    bgColor: "bg-[#FEF0C7]",
  },
  {
    id: 6,
    title: "Intuitive Cloud Interface",
    description: "Access financial data securely, anytime, from anywhere.",
    image: "/Payroll/PM3.png",
    bgColor: "bg-[#FEE2E2]",
  },
];
      ...
      <div className="relative mx-auto max-w-[1400px] px-4 sm:px-6 md:px-10 lg:px-20">
        ...
        <div className="mb-10 text-center lg:mb-12">
          <h2 className="mb-6 font-outfit text-[32px] font-medium leading-[100%] tracking-[0px] text-[#080808] sm:text-[40px] lg:text-[48px]">
            Industry-Leading Finance & Accounting Modules
          </h2>
