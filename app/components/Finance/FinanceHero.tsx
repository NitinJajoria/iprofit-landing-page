				...
				<div className="flex flex-col gap-16 lg:flex-row lg:items-center lg:justify-between">
					...
					<div className="max-w-2xl lg:flex-1">
						...
						<h1 className="mb-8 font-outfit text-[32px] font-semibold leading-tight text-[#080808] sm:text-[40px] lg:text-[48px] lg:leading-[80px]">
							Automated Finance.{" "}
							<span className="font-medium">Real-Time Clarity.</span>
						</h1>
						...
						<p className="max-w-xl font-outfit text-[16px] font-normal leading-[1.6] text-[#31373D] sm:text-[18px] lg:text-[19px] lg:leading-[40.8px]">
							Gain complete control over every financial transaction — from
							accounting and budgeting to taxation, vendor payments, and
							reporting — all from one unified ERP dashboard. iProfit’s finance
							and accounting module is built to deliver accuracy, compliance,
							and real-time visibility, without manual effort or fragmented
							systems.
						</p>
					</div>
