...
const benefits = [
	"Centralized asset register & lifecycle tracking",
	"Automated depreciation calculations",
	"Compliance-ready audit reports",
	"Real-time asset dashboards",
	"Reduced asset loss and mismanagement",
];
				...
				<div className="flex flex-col items-center text-center">
					<div className="max-w-4xl">
						<h2
							...
							style={{ fontFamily: "'Outfit', sans-serif" }}
						>
							See How iProfit Transforms Asset Management
						</h2>
						<p
							className="mb-10 text-[18px] font-normal leading-relaxed text-[#31373D] sm:text-[20px] lg:text-[24px]"
							style={{ fontFamily: "'Outfit', sans-serif" }}
						>
							From tracking asset acquisition to managing depreciation,
							transfers, and disposal — iProfit helps organizations gain
							control, reduce risk, and improve asset visibility.
						</p>
						<BookDemoButton
