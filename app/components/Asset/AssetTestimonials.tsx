...
const testimonials = [
  {
    ...
    description: "“Implementing iProfit gave us a single source of truth for our assets and finances. The real-time dashboards have significantly improved our control and decision-making.”",
  },
  {
    id: 2,
    name: "Maninder Bajwa",
    role: "CEO, IT Services Firm",
    image: "/Testimonials/T2.png",
    description: "“As a growing IT firm, we needed a system that could manage assets alongside compliance and operations. iProfit delivered exactly that.”",
  },
];

export default function AssetTestimonials() {
  ...
  return (
    <section className="bg-white px-4 pb-0 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-[1400px] px-6 sm:px-12 lg:px-20">
        ...
        <div 
          ref={scrollRef}
          className="no-scrollbar flex snap-x snap-mandatory overflow-x-auto gap-6 pb-8 sm:grid sm:grid-cols-2 sm:gap-8 sm:overflow-x-visible lg:grid-cols-2 max-w-5xl mx-auto"
        >
          {testimonials.map((item) => (
            <div
              key={item.id}
              className="flex w-full shrink-0 snap-center flex-col rounded-[40px] border border-[#191A23] bg-white p-8 shadow-[4px_4px_0px_0px_#191A23] transition-all sm:w-full sm:shrink"
            >
